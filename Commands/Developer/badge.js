  ...
  async execute(client, message, args) {
    ...
    if (!optionOne) {
      ...
      if (giveBadge === 'owner') {
        ...
        const ownerGrantEmbed = new MessageEmbed()
          .setTitle(':medal: Compto Badges')
        ...
        const staffGrantEmbed = new MessageEmbed()
          .setTitle(':medal: Compto Badges')
        ...
        const cookieGrantEmbed = new MessageEmbed()
          .setTitle(':medal: Compto Badges')
        ...
        const betaGrantEmbed = new MessageEmbed()
          .setTitle(':medal: Compto Badges')
        ...
        const oldPalGrantEmbed = new MessageEmbed()
          .setTitle(':medal: Compto Badges')
